	...
	if not Continued then
		CustomData = {
			...
			Pills = {
				...
				PHANTOM = {Data = false},
				YUM = {Data = false, NumUses = 0, NumDamage = 0, NumShotSpeed = 0, NumTears = 0, NumLuck = 0},
				YUCK = {Data = false, NumUses = 0}
			}
		}
...
if EID then
	...
	EID:addPill(Pills.PHANTOM, "You take false damage three times")
end
